<?php load_header() ?>
<h1>My Timeoff requests <?php echo anchor('timeoff/new_timeoff_request', 'Add New', array('class' => 'button ui-helper-reset')); ?></h1>
		...
		<table cellpadding="0" cellspacing="0" border="0">
			...
			<tbody>
				...
				<tr class="ui-helper-reset">
					...
					<td>
						<?php echo anchor('timeoff/edit/'.$timeoff_request->ID, 'edit'); ?>/<?php echo anchor('timeoff/delete/'.$timeoff_request->ID, 'delete', array('class' => 'delete')); ?>
					</td>
				</tr>
				<?php endforeach; else: ?>
				<tr class="ui-helper-reset">
