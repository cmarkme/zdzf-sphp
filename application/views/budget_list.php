<?php load_header() ?>
<h1>Budgets <?php echo anchor('budget/create', 'Add New', array('class' => 'button ui-helper-reset')); ?></h1>
		...
		<table cellpadding="0" cellspacing="0" border="0">
			...
			<tbody>
				...
				<tr class="ui-helper-reset">
					...
					<td>
						<?php echo anchor('budget/edit/'.$budget->ID, 'edit'); ?>/<?php echo anchor('budget/delete/'.$budget->ID, 'delete', array('class' => 'delete')); ?>
					</td>
				</tr>
				<?php endforeach; else: ?>
				<tr class="ui-helper-reset">
