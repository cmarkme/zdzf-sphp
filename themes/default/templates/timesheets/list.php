...
<h1>Timesheets <?php if(can_this_user('timesheet/new_timesheet')) echo anchor('timesheet/new_timesheet', 'Add New', array('class' => 'button ui-helper-reset')); ?></h1>

<div class="ui-block wide">
	<h3><a href="#">Recent Timesheets</a></h3>
	<div>
		...
		<table cellpadding="0" cellspacing="0" border="0" style="width: auto;" class="search-table">
			<thead>
				...
				<tr>
					<th></th>
					<td colspan="3"><?php echo get_csv_download_link('timesheet') ?></td>
				</tr>
				<?php endif; ?>
			</thead>
			<tbody class="ui-helper-hidden search-more-options">
				<tr>
					...
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							<td>Start Date: <?php echo form_hidden('filters[search_val][]', 'period_start') ?></td>
							<td><?php echo form_dropdown('filters[search_type][]', array('equals' => '=', 
								'not_equal' => '!=', 
								'less_than' => '<', 
								'less_than_equal' => '<=',
								...
								'greater_than_equal' => '>=',
								'like' => 'Like')); ?></td>
							<td><?php echo form_input('filters[search_value][period_start]', @$_GET['filters']['search_value']['period_start'], 'class="datepicker"');?> </td>
						</tr>
						<tr>
							<td>End Date: <?php echo form_hidden('filters[search_val][]', 'period_end') ?></td>
							<td><?php echo form_dropdown('filters[search_type][]', array('equals' => '=', 
								'not_equal' => '!=', 
								'less_than' => '<', 
								'less_than_equal' => '<=',
								...
								'greater_than_equal' => '>=',
								'like' => 'Like')); ?></td>
							<td><?php echo form_input('filters[search_value][period_end]', @$_GET['filters']['search_value']['period_end'], 'class="datepicker"');?> </td>
						</tr>
						<tr>
