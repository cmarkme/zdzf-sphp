...
<h1>Edit Timesheet Template</h1>

<?php echo form_open(site_url('timesheet/edit_template/'.$this->uri->segment('3'))) ?>
		...
		<table cellpadding="0" cellspacing="0" border="0">
			<tbody>
				<tr>
					...
					<td>
						<?php echo form_dropdown('user_id', $users, $user); ?>
					</td>
				</tr>
			</tbody>
		</table>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="week1">
			<tbody>
				...
				<tr class="week1-row-<?php echo $i; echo (($i == 0) ? ' clone' : '')?>">
					...
					?>
					<td style="width: 300px;" valign="top"><?php echo form_dropdown_extend('week1[account][]', $accounts, $week1['account'][$i], 'style="width: 150px;" class="account-select"'); ?></td>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="week2">
			<tbody>
				...
				<tr class="week2-row-<?php echo $i; echo (($i == 0) ? ' clone' : '')?>">
					...
					?>
					<td style="width: 300px;" valign="top"><?php echo form_dropdown_extend('week2[account][]', $accounts, $week2['account'][$i], 'style="width: 150px;" class="account-select"'); ?></td>
...
<p class="clear">
	...
	<?php if(can_this_user('new_from_tempalte')): ?>
	<?php echo form_submit('submit_request', 'Create New Timesheet for the Current Pay Period from this Template', 'class="submit-approval" id="timesheet_approval"') ?>
	<?php endif; ?>
</p>
