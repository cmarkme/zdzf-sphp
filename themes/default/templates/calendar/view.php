...
<div class="tabs">
	...
	<div id="calendar">
	<?php 
	echo $this->calendar->generate(($this->uri->segment(2) == 'page' ? '' : $this->uri->segment(2)), $this->uri->segment(3), $caldata);
	?>
	</div>
	<div id="list">
		...
		<table cellpadding="0" cellspacing="0" border="0" class="sort">
			...
			<tbody>
				...
				<tr class="ui-helper-reset">
					...
					<td>
					<?php if(can_this_user('calendar/edit/all') || (can_this_user('calendar/edit') && (in_array($list->person_in_charge, $manage) || in_array($list->created_by, $manage)))): ?>
						<?php echo anchor('calendar/edit/'.$list->ID, 'edit'); ?> 		
					<?php endif; ?>

					<?php if(can_this_user('calendar/delete/all') || (can_this_user('calendar/delete') && (in_array($list->person_in_charge, $manage) || in_array($list->created_by, $manage)))): ?>
