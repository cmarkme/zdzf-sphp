...
<h1>My Travel requests <?php if(can_this_user('travel/new_travel_request')) echo anchor('travel/new_travel_request', 'Add New', array('class' => 'button ui-helper-reset')); ?></h1>
	...
	<div>
		...
		<table cellpadding="0" cellspacing="0" border="0" style="width: auto;" class="search-table">
			<thead>
				...
				<tr>
					<th></th>
					<td colspan="3"><?php echo get_csv_download_link('travel', $this->user->ID) ?></td>
				</tr>
				<?php endif; ?>
			</thead>
