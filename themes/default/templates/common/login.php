...
<div class="ui-widget ui-widget-content ui-corner-all login-box">
	...
	<?php echo img(array('src' => 'themes/default/images/logo_alz_full.png', 'id' => 'alz_logo_full')); ?>
	...
	<div class="boxBody">
		...
		<p><?php echo form_input(array('name'=>'usr', 'id'=>'usr', 'value'=>set_value('usr', $login) ));?></p>
		<p><?php echo form_password(array('name'=>'pwd', 'id'=>'pwd', 'value'=>'Password' ));?></p>
