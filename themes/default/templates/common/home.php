	...
	<div>
		<table width="100%" border="0" cellpadding="3" cellspacing="0" >
			...
			<tbody>
				...
				<tr>
					<td><a href="<?php echo site_url('timeoff/edit/'.$timeoff_request->ID) ?>"><?php echo $timeoff_request->first_name.' '.$timeoff_request->last_name; ?></a></td>
	...
	<div>
		<table width="100%" border="0" cellpadding="3" cellspacing="0" >
			...
			<tbody>
				...
				<tr>
					<td><a href="<?php echo site_url('timesheet/edit/'.$timesheet->ID) ?>"><?php echo $timesheet->first_name.' '.$timesheet->last_name; ?></a></td>
