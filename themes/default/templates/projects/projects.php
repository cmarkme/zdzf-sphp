...
<div class="ui-block wide">
	...
	<div>
		...
		<table cellpadding="0" cellspacing="0" border="0">
			<thead>
				<tr>
					<th>Created <?php echo get_sort_link('budget', 'fund'); ?></th>
					<th>Ordered By <?php echo get_sort_link('budget', 'fund'); ?></th>
					<th>Status <?php echo get_sort_link('budget', 'fund'); ?></th>
					<th>Order Id <?php echo get_sort_link('budget', 'fund'); ?></th>
					<th>Invoiced <?php echo get_sort_link('budget', 'fund'); ?></th>
					<th>Pmt. Requested <?php echo get_sort_link('budget', 'fund'); ?></th>
					<th>Total <?php echo get_sort_link('budget', 'fund'); ?></th>
					<th></th>
				</tr>
			</thead>
			<tbody>
