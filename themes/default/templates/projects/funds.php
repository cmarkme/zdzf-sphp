...
<h1>Project Funds <?php echo anchor('projects/new_budget/fund', 'Add New', array('class' => 'button ui-helper-reset')); ?></h1>

<div class="ui-block wide">
	<h3><a href="#">Order Details</a></h3>
	<div>
		<!-- <?php echo form_open(site_url('project/grant_fund'), array('method' => 'get')) ?>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="sort">
			<thead>
				<tr>
					<th>Status <?php echo get_sort_link('general_fund', 'current_status'); ?></th>
					<th>Title <?php echo get_sort_link('general_fund', 'grant_title'); ?></th>
					<th>Total Amount of Grant <?php echo get_sort_link('general_fund', 'total_amt_grant'); ?></th>
					<th>Contract Start Date <?php echo get_sort_link('general_fund', 'start_date'); ?></th>
					<th>Contract End Date <?php echo get_sort_link('general_fund', 'end_date'); ?></th>
					<th>Total Expense</th>
					<th></th>
				</tr>
			</thead>
