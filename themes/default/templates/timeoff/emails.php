...
<?php echo form_open('timeoff/emails', '', array('save_emails' => 'true')); ?>
				...
				<table border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td class="message-header">Shortcodes available in this email: <br>
							[first_name], [last_name], [email], [manager_first_name], [manager_last_name], [current_status], [request_type], [combination], [days_or_hours],[request_start], [request_end], [comments], [date_created]</td>
					</tr>
				</table>
