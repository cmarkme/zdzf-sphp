...
<h1>Timeoff requests <?php if(can_this_user('timeoff/new_timeoff_request')) echo anchor('timeoff/new_timeoff_request', 'Add New', array('class' => 'button ui-helper-reset')); ?></h1>

<div class="ui-block wide">
	<h3><a href="#">Recent Timeoff requests</a></h3>
	<div>
		<?php echo form_open(site_url('timeoff'), array('method' => 'get')) ?>
		<table cellpadding="0" cellspacing="0" border="0" style="width: auto;" class="search-table">
			<thead>
				...
				<tr>
					<th></th>
					<td colspan="3"><?php echo get_csv_download_link('timeoff') ?></td>
				</tr>
				<?php endif; ?>
			</thead>
		...
		<?php echo form_open(site_url('timeoff')) ?>

		<table cellpadding="0" cellspacing="0" border="0" class="sort">
			<thead>
				<tr>
					<th>Created <?php echo get_sort_link('timeoff', 'date_created'); ?></th>
					<th>Name <?php echo get_sort_link('my_timeoff_requests', 'first_name'); ?> <?php echo get_sort_link('my_timeoff_requests', 'last_name'); ?></th>
					<th>Start Date <?php echo get_sort_link('timeoff', 'request_start'); ?></th>
					<th>End Date <?php echo get_sort_link('timeoff', 'request_end'); ?></th>
					<th>Status <?php echo get_sort_link('timeoff', 'current_status'); ?></th>
					<th></th>
				</tr>
			</thead>
			<tbody>
