...
<?php echo form_open('timesheet/emails', '', array('save_emails' => 'true')); ?>
				...
				<table border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td class="message-header">Shortcodes available in this email: <br>
							[first_name], [last_name], [email], [manager_first_name], [manager_last_name], [period_start], [period_end], [chargable_hours], [holiday], [unpaid_time_off], [personal_time], [total_hours], [vacation], [sicktime], [birthday], [other], [date_created]</td>
					</tr>
				</table>
