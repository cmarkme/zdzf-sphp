...
<?php echo form_open(site_url('admin/calendar_settings')) ?>
...
<div class="ui-block wide">
	...
	<div>
		<table cellpadding="0" cellspacing="0" border="0" class="clone-form">
			<tbody>
				<tr>
					<th style="width: 100px; vertical-align: top; padding-top: 10px;">Resources</th>
					<td colspan="5">
						<table cellpadding="0" cellspacing="0" border="0" class="options-table">
							<?php foreach($calendar_resources as $resource): ?>
							<?php if(strlen($resource)): ?>
							<tr>
								<td class="no-border"><?php echo form_input('settings[calendar_resources][]', $resource); ?><span class="button-remove"></span></td>
							</tr>
							<?php endif; ?>
							<?php endforeach; ?>
							<tr>
								<td class="no-border"><?php echo form_input('settings[calendar_resources][]'); ?><span class="button-add"></span></td>
							</tr>
						</table>
					</td>
				</tr>
...
<?php echo form_hidden('save_resources', 'save'); ?>
<?php form_close(); ?>
